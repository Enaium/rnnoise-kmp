 ...
 * Ships librnnoise_jni.dylib as a classpath resource at
 * /cn/enaium/rnnoise/native/darwin-aarch64/, which NativeLoader
...
val libFile = "librnnoise_jni.dylib"
...
val buildJniLibrary by tasks.registering(Exec::class) {
    group = "build"
    description = "Builds librnnoise_jni.dylib for $classifier."
    onlyIf { canBuildHere }
